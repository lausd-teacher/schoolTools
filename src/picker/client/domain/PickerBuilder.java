...
package picker.client.domain;
import picker.client.callback.AbstractPickerCallback;
import picker.client.callback.PickerCallback;
...
public final class PickerBuilder extends JavaScriptObject {
	...
	public native PickerBuilder addView(ViewId viewId) /*-{
		return this
				.addView(viewId.@picker.client.domain.ViewId::getValue()());
	}-*/;
	...
	public native PickerBuilder disableFeature(Feature feature) /*-{
		return this
				.disableFeature(feature.@picker.client.domain.Feature::getValue()());
	}-*/;
	...
	public native PickerBuilder enableFeature(Feature feature) /*-{
		return this
				.enableFeature(feature.@picker.client.domain.Feature::getValue()());
	}-*/;
	...
	public native boolean isFeatureEnabled(Feature feature) /*-{
		return this
				.isFeatureEnabled(feature.@picker.client.domain.Feature::getValue()());
	}-*/;
	...
	public native PickerBuilder addCallback(AbstractPickerCallback callback) /*-{
		...
		this.callbackQueue = function(object) {
			...
			@picker.client.callback.PickerCallbackDispatcher::dispatch(Lpicker/client/callback/AbstractPickerCallback;Lpicker/client/domain/result/BaseResult;)(callback, object);
		};
		this.setCallback(this.callbackQueue);
		return this;
	}-*/;
	
	/* just straigt api call to setCallback */
