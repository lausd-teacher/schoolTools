...
public final class DocsUploadView extends JavaScriptObject {
  ...
  public native DocsUploadView setIncludeFolders(boolean include) /*-{
	  this.setIncludeFolders(include);
	  return this;
  }-*/;
  
  public native DocsUploadView setParent(String parent)/*-{
  ...
  public native DocsUploadView setQuery(String string) /*-{
