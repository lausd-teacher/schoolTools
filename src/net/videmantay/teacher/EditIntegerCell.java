...
public class EditIntegerCell extends  AbstractEditableCell<String, EditIntegerCell.ViewData> {

	  interface Template extends SafeHtmlTemplates {
	    @Template("<input type=\"number\" value=\"{0}\" tabindex=\"-1\" class='pointsEarnedInput'></input>")
	    SafeHtml input(Integer value);
	  }
	  ...
	  static class ViewData {
	    ...
	    public ViewData(String text) {
	      this.original = Integer.parseInt(text);
	      this.integer = Integer.parseInt(text);
	      this.isEditing = true;
	    ...
	    public boolean equals(Object o) {
	      ...
	      return equalsOrBothNull(original, vd.original)
	          && equalsOrBothNull(integer, vd.integer) && isEditing == vd.isEditing
	    ...
	    @Override
	    public int hashCode() {
	      return original.hashCode() + integer.hashCode()
	   ...
	   *          instance
	   */
	  public EditIntegerCell(SafeHtmlRenderer<String> renderer) {
	  ...
	  public void render(Context context, String value, SafeHtmlBuilder sb) {
	    ...
	    if (viewData != null && !viewData.isEditing() && value != null
	        && value.equals(viewData.getInteger())) {
	      clearViewData(key);
	      viewData = null;
	    }
	    ...
	    if (viewData != null) {
	      Integer text = viewData.getInteger();
	  ...
	  private void commit(Context context, Element parent, ViewData viewData,
	    ...
	    clearInput(getInputElement(parent));
	    setValue(context, parent, viewData.getOriginal().toString());
	    if (valueUpdater != null) {
	      valueUpdater.update(Integer.parseInt(value));
	    }
	  }

	  private void editEvent(Context context, Element parent, String value,
	      ViewData viewData, NativeEvent event, ValueUpdater<Integer> valueUpdater) {
	    String type = event.getType();
	    ...
	    if (keyUp || keyDown) {
	      ...
	      if (keyUp && keyCode == KeyCodes.KEY_ENTER) {
	        ...
	        // Cancel edit mode.
	        String originalText = viewData.getOriginal().toString();
	        if (viewData.isEditingAgain()) {
	          viewData.setInteger(originalText);
